...
import logging
import traceback
from sqlalchemy import text  # Import necesario para sentencias SQL directas
...
def update_task(task_id):
    try:
        ...
        allowed_fields = ['name', 'description', 'deadline', 'status', 'is_alive']
